...
## 2026-04-23 policy update note

- Event sales can be paused at app + DB level when artist confirmation is pending; update customer-facing marketing CTA accordingly.
