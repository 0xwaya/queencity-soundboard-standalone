...
## Phase 4 (Ops + discoverability)

1. SEO/local-SEO maintenance (metadata, sitemap, robots, JSON-LD validation)
2. Security hardening follow-up (URL constraints, policy checks, abuse controls)
3. Stability checks in CI (`npm run lint`, `npm run test:run`, periodic build check)
